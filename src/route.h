 ...
 */
Vector *dijikstra(Vector *cities, City *source, City *target,
 ...
 * @param[in] avoid - wskaźnik na drogę, którą omijamy (może być NULL)
 * @param[in] avoid2 - wskaźnik na trasę, której miasta omijamy (może być NULL)
 * @return Wskaźnik na szuakną trasę lub NULL,
 * gdy nie udało się jednoznacznie znaleźć takiej trasy lub zaalokować pamięci
 */
 ...
 * @return Wskaźnik na nowa trasę lub NULL,
 * gdy nie istnieje taki objazd lub nie udało się zaalokować pamięci.
 */
 ...
 * @return Wskaźnik na nową trasę lub NULL,
 * gdy nie udało się jej jednoznacznie wyznaczyć.
 */
